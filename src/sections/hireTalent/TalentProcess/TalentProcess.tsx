    ...
    return (
        <div className={styles.ProcessWrapper}>
            <div className='container'>
                ...
                <Text text={'Our 3 step process takes the team from inception to finished product. NYV Digital Solutions ensures hiring a dedicated development team within 24 hours.'} className='text-grey max-w-[900px] text-center mx-auto' />
