  ...
  return (
    ...
    {/* Seo Purpose */}
      <Head>
        ...
        <meta
          name="description"
          content=" NYV - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - Your Partner in Innovation. Our 'Home' page is the gateway to exceptional software, AI, blockchain, and technology services."
          key="desc"
        />
      </Head>
      <HeroBanner />
