                ...
                <SwiperSlide key={index}>
                  <Card className={styles.TestimonialCard}>
                    ...
                    <div className="mt-[29px]">
                      <p className="text-lg font-poppins font-normal text-grey mb-[24px]">
                        {data.text}
                      </p>
                      <a className="text-purple text-lg font-poppins font-semibold">
                        {data.title}
                      </a>
                      <p className="text-primary-dark text-lg font-poppins font-normal mt-[4px]">
                        {data.name}
                      </p>
                    </div>
                  </Card>
