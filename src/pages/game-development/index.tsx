  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content=" NYV Digital Solutions LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - NYV Digital Solutions excels in game development. Join us in crafting immersive, entertaining, and interactive games that captivate your audience."
          key="desc"
        />
      </Head>
