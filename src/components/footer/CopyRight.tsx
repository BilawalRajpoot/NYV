    ...
    return (
        <div className='border-t mt-[60px] border-grey'>
            <div className='flex md:justify-between py-[30px] items-center  md:flex-row flex-col'>
                <div className='text-sm text-grey-scale font-poppins font-light	'>&copy;{currentYear} - NYV Digital Solutions  <span className='mx-[15px]'>|</span>  All right reserved</div>
