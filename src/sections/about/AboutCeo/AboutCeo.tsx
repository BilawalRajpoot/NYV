                ...
                <div className="container">
                    <div className="flex w-full gap-[70px]">
                        ...
                        <div className="w-[calc(60%-70px)]">
                            <Text
                                text={`We are a leading mobile app development company in the USA, housing domain-savvy developers to design and develop Android, iOS and cross-platform applications customized to your business needs and identity. So, jump into the NYV Digital Solutions bandwagon today and benefit from our exclusive value-added services!`}
