...
const index = () => {
  return (
    <>
    <Head>
        <title>Web Development | NYV Digital Solutions LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services</title>
 
        <meta
          name="description"
          content=" NYV Digital Solutions LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - NYV Digital Solutions LLC's web development services focus on crafting responsive, user-friendly websites. Discover how we bring your online presence to life."
          key="desc"
        />
      </Head>
